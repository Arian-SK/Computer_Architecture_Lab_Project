...
HD_PWD='C:/Users/radin/Downloads/Proj_CA_Lab8/HW8/HW8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log if_stage_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source if_stage_top.tcl
